...
mod skill_md_tests {
    ...
    fn test_parse_pdf_processor_skill() {
        let skill_md_path = "examples/.claude/skills/pdf-processor/SKILL.md";
    ...
    fn test_parse_hooks_test_skill() {
        let skill_md_path = "examples/.claude/skills/hooks-test-skill/SKILL.md";
        let skill = SkillMdFile::parse(skill_md_path).expect("Failed to parse SKILL.md");
    ...
    fn test_parse_context_fork_skill() {
        let skill_md_path = "examples/.claude/skills/context-fork-skill/SKILL.md";
        let skill = SkillMdFile::parse(skill_md_path).expect("Failed to parse SKILL.md");
    ...
    fn test_parse_code_reviewer_skill() {
        let skill_md_path = "examples/.claude/skills/code-reviewer/SKILL.md";
        let skill = SkillMdFile::parse(skill_md_path).expect("Failed to parse SKILL.md");
...
mod skill_discovery_tests {
    ...
    fn test_discover_all_example_skills() {
        ...
        assert!(packages.len() >= 25, "Should find at least 25 skills (22 original + 3 new)");
...
mod integration_tests {
    ...
    async fn test_multi_skill_discovery() {
        ...
        assert!(packages.len() >= 25, "Should find at least 25 skills");
